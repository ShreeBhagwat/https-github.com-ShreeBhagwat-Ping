...
func startGroupChat(group: Group) {
    ...
    let chatRoomId = group.groupDistionary[kGROUPID] as! String
    let members = group.groupDistionary[kMEMBERS] as! [String]
    
    createRecent(members: members, chatRoomId: chatRoomId, withUserUserName: group.groupDistionary[kNAME] as! String, type: kGROUP, users: nil, avatarOfGroup: group.groupDistionary[kAVATAR] as? String)
}
