...
class Encryption {
    ...
    class func decrpytText(chatroomId: String, encryptedText: String) -> String {
        let decryptor = RNCryptor.Decryptor(password: chatroomId)
        let encryptedData = NSData(base64Encoded: encryptedText, options: NSData.Base64DecodingOptions(rawValue: 0))
