...
class MapViewController: UIViewController {
    ...
    @objc func openInMap(){
        ...
        let cordinates = location.coordinate
        let regionSpan = MKCoordinateRegion(center: cordinates, latitudinalMeters: regionDestination, longitudinalMeters: regionDestination)
        ...
        let placeMark = MKPlacemark(coordinate: cordinates, addressDictionary: nil)
